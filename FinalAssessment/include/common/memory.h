 ...
 *
 * Given two byte pointers (one source and one destination) and a length of bytes 
 * this function moves data from the source location to the destination.
 *
 ...
 *
 * Given two byte pointers (one source and one destination) and a length of bytes 
 * this function copies data from the source location to the destination.
 *
 * @param src Pointer to the source location
 * @param dst Pointer to the destination
 * @param length The data length in bytes
 ...
 * this function sets all locations of that memory to a given value.
 *
 * @param src Pointer to the source location
 * @param length The data length in bytes
